...
import os
from turtle import *
from imprimeurPLT import os


fileName = "Untitled-1.plt"
print("allo")
...
class Trace:
    ...
    def __init__(self, decalageX, decalageY, largeurPouces, numeroPort, fileName):
        ...
        self.fichierDebut = "BEGIN.txt"
        self.fichierFin = "END.txt"
    ...
    def convertirEnString(self):
        self.lines = [line[0] + trans(line[1]) +',' + trans(line[2]) +";\n" for line in self.lines]
    ...
    def tracer(self):
        ...
        print(os.system("mode " + numeroPort + " 19200, n, 8, 1, p"))
        os.system('copy /b ' + fichierSortie + ' ' +numeroPort)
        os.system('pause')
...
class MyWindowClass(QtGui.QMainWindow, form_class):
    ...
    def getTrace(self):
        if self.bonnesValeurs(self.entryEspaceX.text(), self.entryEspaceY.text(), self.entryLargeur.text(), self.entryPort.text(), self.labelFichier.text()):
